...
export default function Survey() {
  ...
  const handleAcceptEmployee = async (row) => {
    try {
      ...
      console.log(user);
      const isDelete = window.confirm('Are you sure you want to approve request of Employee having name ' + user.name);
      if (isDelete) {
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { surveyId, name, department, mobileNo, email } = row;
                        ...
                        <>
                          <TableRow hover key={surveyId} tabIndex={-1} role="checkbox" selected={selectedUser}>
                            ...
                            <TableCell align="left">
                              ...
                              >
                                <Iconify icon={'eva:edit-outline'} /> {/* Accept icon */}
                              </IconButton>
                              <IconButton
                                size="large"
