      ...
      <>
        ...
        <Card>
          <UserListToolbar
            ...
            name="Pending List of Employees"
          />
                          ...
                          <TableRow hover key={empId} tabIndex={-1} role="checkbox" selected={selectedUser}>
                            ...
                            <TableCell align="left">
                              <IconButton
                                size="large"
                                color="inherit"
                                className="bg-green-300 hover:bg-green-500 mb-2 lg:ml-2  2xl:mb-0"
                                onClick={() => {
                              ...
                              <IconButton
                                size="large"
                                className="bg-red-300 hover:bg-red-500 mt-2 2xl:mt-0 2xl:ml-2 "
                                color="inherit"
                                onClick={() => {
